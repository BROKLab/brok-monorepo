...
import { formatBN, formatCurrency, formatOrgNumber } from "../../src/utils/Formatters";
              ...
              <Grid.Container gap={1} alignItems="center">
                ...
                <Grid xs={6} >
                  <Button.Group size="xs">
                    <Button as="a" target={"_blank"} href={`https://goerli-rollup-explorer.arbitrum.io/token/${address}`}>Blockchain</Button>
                  ...
                  <Table.Body>
                    {capTable.shareholders.map(shareholder => (
                      <Table.Row key={shareholder.ethAddress} >
                        ...
                        <Table.Cell>
                          <Button.Group size="xs">
                            <Button as="a" target={"_blank"} href={`https://goerli-rollup-explorer.arbitrum.io/address/${shareholder.ethAddress}`}>Blockchain</Button>
